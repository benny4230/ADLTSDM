...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("object", 1, "topological")
        self.add_class("object", 2, "trivial")
        #self.add_class("object", 3, "valleyA")
        #self.add_class("object", 4, "valleyB")
        ...
        for a in annotations:
            ...
            name_dict = {"topological": 1,"trivial": 2}
            #name_dict = {"0": 1,"1": 2}
            # key = tuple(name_dict)
